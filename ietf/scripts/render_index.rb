...
html = <<~HTML
  ...
  #{draft_rows}
        ...
        <h2>Node.js SDKs</h2>
        <p>
          Official packages are published under the
          <code>@aep-foundation</code> npm scope. Choose the package for the
          protocol role or framework you are implementing.
        </p>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              <td class="draft-id" data-label="Package">Core</td>
              <td data-label="Purpose">Wire types, validation, signing helpers, and HTTP primitives.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/core"><code>@aep-foundation/core</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Agent</td>
              <td data-label="Purpose">Discovery, enrollment, credentials, authentication, status, and revocation workflows.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/agent"><code>@aep-foundation/agent</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Service</td>
              <td data-label="Purpose">Protocol handlers, policy hooks, persistence interfaces, credential issuance, and authentication.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/service"><code>@aep-foundation/service</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Platform</td>
              <td data-label="Purpose">Hosted Agent identity provisioning, delegated signing, verification, and lifecycle helpers.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/platform"><code>@aep-foundation/platform</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Conformance</td>
              <td data-label="Purpose">Published schemas, test vectors, and conformance helpers for implementers.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/conformance"><code>@aep-foundation/conformance</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Service Policy</td>
              <td data-label="Purpose">Service Policy extension types and validation.</td>
              <td data-label="npm"><a href="https://www.npmjs.com/package/@aep-foundation/service-policy"><code>@aep-foundation/service-policy</code></a></td>
            </tr>
            <tr>
              <td class="draft-id" data-label="Package">Framework adapters</td>
              <td data-label="Purpose">Service integration for Express, Fastify, Hono, and Next.js.</td>
              <td data-label="npm">
                <span class="links">
                  <a href="https://www.npmjs.com/package/@aep-foundation/express">Express</a>
                  <a href="https://www.npmjs.com/package/@aep-foundation/fastify">Fastify</a>
                  <a href="https://www.npmjs.com/package/@aep-foundation/hono">Hono</a>
                  <a href="https://www.npmjs.com/package/@aep-foundation/next">Next.js</a>
                </span>
              </td>
            </tr>
          </tbody>
